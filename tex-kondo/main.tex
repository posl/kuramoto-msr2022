...
\subtitle{-- A Preliminary Study of Using Movies and Images to Report Issues on GitHub --}
...
\newcommand{\RQone}{Do the visual issue reports have active discussions?}
\newcommand{\RQtwo}{Do the visual issue reports are resolved quickly?}
% ============================================================
