...
We collect 3,819 videos and 33,079 images from 711,160 issues on 4,173 publicly available repositories. Contrary to our hypothesis, our preliminary analysis shows that the visual issue reports need a longer time to be resolved. In addition, we observe that most discussions in visual issue reports are concerned with either conditions for reproduction (e.g., when) or GUI (e.g., dropdowns.) 
