\begin{abstract}
Issue reports are utilized to report bugs to developers from reporters. 
...
such as the steps to reproduce bugs as the screen capture. 
...
visual issue reports in software development on GitHub exist so far. 
In this paper, we conducted a preliminary study to clarify
the characteristics of visual issue reports. 
