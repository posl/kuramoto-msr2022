...
We collect 1,230 videos and 18,760 images from 226,286 issues on 4,173 publicly available repositories. 
%Contrary to our hypothesis, our preliminary analysis shows that the visual issue reports need a longer time to be resolved. 
Our preliminary analysis shows that issue reports with images are described in fewer words than non-visual issue reports.
...
% GitHub has started to provide a new feature to share videos on GitHub.
% Reporters can visualize issue reports by attaching videos
...
% % consists of videos and images in publicly available 
% % repositories on GitHub and show the result of the initial analysis. 
