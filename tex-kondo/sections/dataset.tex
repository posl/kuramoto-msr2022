...
%While the number of sampled projects seems odds, 
%上の分，なくても繋がるし，表現としてネガティブなので消した．
...
Consequently, we downloaded 21,003 images and 1,324 movies with the collected URLs.\kura{move this underside?}
...
The number of issue reports that meet this condition is 263,596 (xx.xx\%).\kura{move to here?}
...
\kashiwa{This is too general...Why not mann-whitney.}
