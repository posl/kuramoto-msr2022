...
%\textbf{DescriptionLength of visual issue reports is no-significantly different from the others. }
...
the $Mov$ category in 
this dimension result in the largest or faster values than those of 
...
%\textbf{The visual issue reports need a longer time to be resolved than the issue reports in the None category. }
