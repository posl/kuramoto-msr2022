...
These issue reports are counted in both $Img$ and $Vid$ categories (only around 0.07\%). 
Thus, the total number of downloaded issue reports is different from the sum of issues (711,160).
...
We collected 3,819 videos and 33,079 images from 711,160 issue reports. 
Out of the collected issues, only 4.65\% of issue reports have images, and 0.54\% have videos. 
While this number seems to be small, looking into the trend shown in \fig{fig:data-cat-trend}, the rate of visual issue reports by year is increasing from 2017 to 2020. 
