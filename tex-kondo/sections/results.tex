...
We collected XXX videos and XXX images from XXX issue reports. Out of the collected issues, only 4.65\% of issue reports have images, and 0.54\% have videos. While this number seems to be small, looking into the trend shown in \fig{fig:data-cat-trend}, the rate of visual issue reports by year is increasing from 2017 to 2020. The ratio of visual issue reports reached to 5\% between 2018 and 2021. Also, we found that GitHub officially launched the function to share videos and images in May 2021 but developers often had uploaded videos before the beta release~\citep{github-video-blog}. 
